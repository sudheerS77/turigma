...
const EmptyMetriceComponent = () => {
  return (
    <>
      <div className="w-1/2 border border-gray-100 rounded-md shadow-md p-2.5">
        ...
        <div className="flex flex-wrap gap-4 text-gray-50">
          {/* HOLDING */}
          <div className="w-full grid grid-cols-4 gap-3 bg-azure-blue items-center justify-center font-semibold">
