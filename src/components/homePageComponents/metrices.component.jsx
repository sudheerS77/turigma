...
var MetriceComponent = (props) => {
  ...
  return (
    <>
      <div className="w-1/2 h-full rounded-md shadow-md p-2.5 border-2 border-gray-300">
        ...
        <div className="flex flex-wrap gap-4 text-gray-50 mx-2">
          {/* HOLDING */}
          <div className="w-full grid grid-cols-4 text-black  items-center justify-center font-semibold border-2 border-blue-800 rounded-md">
